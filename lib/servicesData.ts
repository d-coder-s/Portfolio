// /* ─────────────────────────────────────────────────────────────
//    Dcoder — Services data
//    Single source of truth for Services list + detail pages
// ───────────────────────────────────────────────────────────── */
...
//     description:
//       "Custom, highly responsive and scalable websites built to perform. We specialise in React, Next.js, and Node.js — crafting fast, secure, SEO-ready web applications tailored to your business goals. From landing pages to complex enterprise platforms.",
//     imgSrc: "/figma/webb.webp",
//     tags: ["React", "Next.js", "Node.js", "TypeScript", "SQL"],
//     accent: "#f59e0b",
//     stickyText: "avg load time\nunder 1.2s ⚡",
//     stickyBg: "bg-dc-sticky-yellow",
//     heroLabel: "// 01 — web development",
//     overview:
//       "We build websites that don't just look good — they perform. Every project starts with understanding your users, your goals, and the metrics that matter. Then we build: fast, accessible, and conversion-optimised. No templates, no bloated frameworks — just clean, maintainable code that scales with your business.",
//     highlights: [
//       {
//         icon: "⚡",
//         title: "Performance First",
//         body: "Core Web Vitals optimised. Sub-1.5s load times as standard. We don't ship slow.",
//       },
//       {
//         icon: "🔒",
//         title: "Security Built-in",
//         body: "HTTPS, input sanitisation, auth best practices, and regular dependency audits.",
//       },
//       {
//         icon: "📱",
...
//         icon: "🔍",
//         title: "SEO Ready",
//         body: "Server-side rendering, semantic HTML, structured data, and meta optimisation.",
//       },
//       {
//         icon: "♿",
//         title: "WCAG Accessible",
//         body: "Keyboard navigable, screen-reader friendly, contrast-compliant by default.",
//       },
//       {
//         icon: "🔧",
//         title: "Easy to Maintain",
//         body: "Clean code, thorough docs, and handoff support so your team can own it.",
//       },
//     ],
//     approach: [
//       {
...
//         desc: "We audit your existing setup, research your users, and map out the information architecture before writing a single line of code.",
//       },
//       {
//         step: "02",
...
//         step: "03",
//         title: "Development",
//         desc: "Agile sprints, weekly demos, staging environment. You see real progress every week.",
//       },
//       {
//         step: "04",
//         title: "QA & Optimisation",
//         desc: "Cross-browser testing, Lighthouse audits, performance tuning, and accessibility checks.",
//       },
//       {
//         step: "05",
...
//       {
//         category: "DevOps",
//         items: ["Vercel", "Netlify", "AWS", "Docker", "GitHub Actions"],
//       },
//     ],
//     faqs: [
//       {
//         q: "How long does a website project take?",
//         a: "A landing page takes 1–2 weeks. A full web app typically 6–12 weeks. We give you a realistic estimate after the discovery call.",
//       },
//       {
...
//         a: "We build with SEO best practices baked in — SSR, semantic markup, structured data, and performance. Rankings depend on content strategy too.",
//       },
//       {
//         q: "Do you offer CMS integration?",
//         a: "Yes — Contentful, Sanity, Strapi, WordPress, or a custom admin panel. Whatever fits your workflow.",
//       },
//     ],
//   },
...
//     description:
//       "High-performance cross-platform mobile applications for iOS and Android. Built with React Native and Flutter, our apps are optimised for speed, security, and exceptional user experience — from ideation and prototyping to App Store deployment.",
//     imgSrc: "/figma/app.webp",
//     tags: ["React Native", "Flutter", "iOS", "Android", "Firebase"],
//     accent: "#06b6d4",
//     stickyText: "cross-platform\nby default ✦",
//     stickyBg: "bg-dc-sticky-blue",
//     heroLabel: "// 02 — app development",
//     overview:
//       "We build mobile apps that users actually want to open. Cross-platform by default — one codebase, two stores, zero compromise on performance. We handle everything from UX design and prototyping to App Store submission and post-launch support.",
//     highlights: [
//       {
//         icon: "📱",
//         title: "Cross-Platform",
//         body: "React Native & Flutter — one codebase for iOS and Android, without sacrificing native performance.",
//       },
//       {
//         icon: "🚀",
//         title: "App Store Ready",
//         body: "We handle submissions, review responses, and metadata for both App Store and Google Play.",
//       },
//       {
//         icon: "🔔",
...
//         icon: "🔐",
//         title: "Secure Auth",
//         body: "OAuth2, biometric login, JWT, and secure token storage — all handled correctly.",
//       },
//       {
//         icon: "📡",
...
//         step: "02",
//         title: "UI/UX Design",
//         desc: "Platform-native design patterns — Material Design for Android, Human Interface for iOS — in Figma.",
//       },
//       {
//         step: "03",
...
//         desc: "Store submission, ASO optimisation, and post-launch monitoring. We're available for 30 days post-launch.",
//       },
//     ],
//     stack: [
...
//       {
//         category: "Backend",
//         items: ["Node.js", "Firebase", "Supabase", "REST APIs"],
//       },
//       { category: "Auth", items: ["Firebase Auth", "OAuth2", "Biometrics"] },
//       {
//         category: "Distribution",
//         items: ["App Store", "Google Play", "TestFlight", "Fastlane"],
//       },
//     ],
//     faqs: [
//       {
//         q: "Should I build native or cross-platform?",
//         a: "For most startups, cross-platform delivers 90% of native performance at 60% of the cost. We'll advise based on your use case.",
//       },
//       {
//         q: "How do App Store submissions work?",
//         a: "We handle the full submission process — screenshots, metadata, review responses — for both stores.",
//       },
//       {
//         q: "Can you update an existing app?",
//         a: "Yes. We work with existing React Native and Flutter codebases. We'll audit before quoting.",
//       },
//       {
//         q: "What about backend infrastructure?",
//         a: "We build and deploy the backend too — REST APIs, Firebase, Supabase — whatever fits your scale.",
//       },
//     ],
//   },
...
//     num: "03",
//     title: "UI/UX Design",
//     tagline: "design that actually works.",
//     description:
//       "User-centred design that balances aesthetics with functionality. We create intuitive interfaces, design systems, and interactive prototypes in Figma — ensuring every touchpoint is purposeful, accessible, and aligned with your brand identity.",
//     imgSrc: "/figma/uiux.jpg",
//     tags: ["Figma", "Prototyping", "User Research", "Design Systems"],
//     accent: "#ec4899",
//     stickyText: "users first.\nalways. 🎨",
//     stickyBg: "bg-dc-sticky-pink",
//     heroLabel: "// 03 — ui/ux design",
//     overview:
//       "Good design is invisible. Great design makes people stay. We obsess over the details that most overlook — micro-interactions, loading states, empty states, error messages. Every pixel has a purpose. We design with real users in mind, backed by research and validated through testing.",
//     highlights: [
//       {
//         icon: "🔬",
...
//         body: "Scalable component libraries that keep your product consistent across every screen.",
//       },
//       {
//         icon: "🖱️",
//         title: "Micro-interactions",
//         body: "Transitions, hover states, loading animations — the details that turn UI into experience.",
//       },
//       {
//         icon: "♿",
...
//       {
//         icon: "📐",
//         title: "Dev-Ready Files",
//         body: "Auto-layout, design tokens, and annotated specs so handoff to devs is seamless.",
//       },
//       {
//         icon: "🧪",
//         title: "Usability Testing",
//         body: "Prototype → test → iterate. We validate designs with real users before build.",
//       },
//     ],
//     approach: [
//       {
...
//         desc: "User personas, job stories, competitive benchmarking, and analytics review.",
//       },
//       {
//         step: "02",
//         title: "Information Architecture",
//         desc: "Sitemaps, user flows, and content hierarchy before any visual work begins.",
//       },
//       {
//         step: "03",
//         title: "Wireframes",
//         desc: "Low-fidelity wireframes for every key screen. Fast iteration, no wasted design time.",
//       },
//       {
//         step: "04",
//         title: "Visual Design",
//         desc: "High-fidelity mockups with your brand identity — typography, colour, iconography.",
//       },
//       {
//         step: "05",
//         title: "Prototype & Test",
//         desc: "Interactive Figma prototype → usability testing → final design refinement.",
//       },
//     ],
//     stack: [
//       {
//         category: "Design Tools",
//         items: ["Figma", "FigJam", "Principle", "Lottie"],
//       },
//       {
//         category: "Research",
//         items: ["Hotjar", "Maze", "UserTesting", "Notion"],
//       },
...
//     faqs: [
//       {
//         q: "Do you design mobile and web?",
//         a: "Yes — responsive web, iOS, and Android. We follow platform-specific guidelines for each.",
//       },
//       {
//         q: "Can you design our brand identity too?",
//         a: "We handle product UI/UX. For full brand identity (logo, brand guide), we can refer trusted partners.",
//       },
//       {
//         q: "What files do we get at the end?",
//         a: "Full Figma source files, exported assets, design tokens, and a component library you own.",
//       },
//       {
//         q: "Will you work with our existing brand?",
//         a: "Absolutely. We extend and apply your existing brand guidelines to new interfaces.",
//       },
//     ],
//   },
...
//     description:
//       "Leverage Artificial Intelligence and Machine Learning to build smarter, automated systems. From predictive analytics and NLP to recommendation engines — our AI/ML solutions are scalable, robust, and built around your unique business challenges.",
//     imgSrc: "/figma/aiml.jpg",
//     tags: ["Python", "TensorFlow", "PyTorch", "OpenAI", "LangChain"],
//     accent: "#10b981",
//     stickyText: "data-driven\ndecisions 🤖",
//     stickyBg: "bg-dc-sticky-mint",
//     heroLabel: "// 04 — ai / ml solutions",
//     overview:
//       "We build AI systems that actually make it to production. Not POCs that gather dust — real, deployed, monitored models that drive measurable business outcomes. From LLM-powered chatbots to computer vision pipelines, we handle the full ML lifecycle: data, training, deployment, and monitoring.",
//     highlights: [
//       {
//         icon: "🧠",
//         title: "LLM Integration",
//         body: "OpenAI, Anthropic, Gemini — RAG pipelines, fine-tuning, and custom agents for your use case.",
//       },
//       {
//         icon: "📈",
//         title: "Predictive Analytics",
//         body: "Demand forecasting, churn prediction, anomaly detection — trained on your real data.",
//       },
//       {
//         icon: "💬",
//         title: "NLP & Chatbots",
//         body: "Intent classification, entity extraction, and context-aware conversational AI.",
//       },
//       {
//         icon: "👁️",
//         title: "Computer Vision",
//         body: "Object detection, image classification, OCR, and document processing pipelines.",
//       },
//       {
//         icon: "🔄",
//         title: "MLOps & Monitoring",
//         body: "Model versioning, drift detection, automated retraining, and production monitoring.",
//       },
//       {
//         icon: "🔗",
//         title: "API-First Delivery",
//         body: "Clean REST/gRPC APIs so your existing products can consume ML features immediately.",
//       },
//     ],
//     approach: [
//       {
...
//         desc: "We define the business problem, success metrics, and data requirements before any modelling.",
//       },
//       {
//         step: "02",
...
//         desc: "Baseline → experimentation → evaluation. We track all experiments and share results.",
//       },
//       {
//         step: "04",
//         title: "Production Deployment",
//         desc: "Containerised model serving, API integration, and load testing.",
//       },
//       {
//         step: "05",
//         title: "Monitor & Improve",
//         desc: "Performance dashboards, drift alerts, and scheduled retraining pipelines.",
//       },
//     ],
//     stack: [
//       {
...
//       {
//         category: "LLM / GenAI",
//         items: ["OpenAI API", "LangChain", "LlamaIndex", "Anthropic"],
//       },
//       { category: "Data", items: ["Pandas", "NumPy", "Spark", "Airflow"] },
//       {
//         category: "Deployment",
//         items: ["FastAPI", "Docker", "AWS SageMaker", "GCP Vertex AI"],
//       },
//     ],
//     faqs: [
//       {
//         q: "Do we need a lot of data to start?",
//         a: "Not always. We assess what you have and recommend approaches — sometimes transfer learning or synthetic data works well.",
//       },
//       {
//         q: "Can you integrate AI into our existing app?",
//         a: "Yes. We expose model predictions as APIs your existing product can consume.",
//       },
//       {
//         q: "How do we know if the model is working?",
//         a: "We set up monitoring dashboards with the business metrics that matter — not just accuracy scores.",
//       },
//       {
//         q: "Is our data safe?",
//         a: "Yes. We work within your data governance requirements. On-premise deployment available.",
//       },
//     ],
//   },
...
//     description:
//       "Immersive 2D and 3D games for mobile, PC, and web platforms. Built with Unity and Unreal Engine, our games deliver rich gameplay mechanics, stunning visuals, and responsive controls — from casual mobile titles to full-scale productions.",
//     imgSrc: "/figma/gaming.png",
//     tags: ["Unity", "Unreal Engine", "C#", "Mobile", "WebGL"],
//     accent: "#f97316",
//     stickyText: "play-tested\n& polished 🎮",
//     stickyBg: "bg-dc-sticky-yellow",
//     heroLabel: "// 05 — game development",
//     overview:
//       "We build games that keep players coming back. Whether it's a casual mobile puzzle, a WebGL browser experience, or a full 3D PC title — we bring the same rigour to game dev as we do to software engineering. Playable prototypes fast, polished builds on schedule.",
//     highlights: [
//       {
//         icon: "🎮",
//         title: "Multi-Platform",
//         body: "iOS, Android, PC, Mac, WebGL — one codebase via Unity, deployed to multiple targets.",
//       },
//       {
//         icon: "⚡",
//         title: "60fps Performance",
//         body: "Optimised draw calls, asset streaming, and LOD systems for smooth gameplay.",
//       },
//       {
//         icon: "🎵",
//         title: "Audio & VFX",
//         body: "Spatial audio, particle systems, shader effects, and haptic feedback integration.",
//       },
//       {
//         icon: "🏆",
//         title: "Monetisation",
//         body: "In-app purchases, ad integration (AdMob, Unity Ads), and subscription models.",
//       },
//       {
//         icon: "📊",
//         title: "Analytics & Events",
//         body: "Player behaviour tracking, funnel analysis, and A/B testing for game design decisions.",
//       },
//       {
//         icon: "☁️",
...
//         step: "01",
//         title: "Concept & GDD",
//         desc: "Game design document, core loop definition, art style direction, and platform targets.",
//       },
//       {
//         step: "02",
//         title: "Prototype",
//         desc: "Playable grey-box prototype in 2–3 weeks. Core mechanics tested before art investment.",
//       },
//       {
//         step: "03",
//         title: "Alpha Build",
//         desc: "Full feature set, placeholder art replaced, audio integration, and internal QA.",
//       },
//       {
//         step: "04",
//         title: "Beta & Polish",
//         desc: "Performance optimisation, bug fixing, balance testing, and store asset preparation.",
//       },
//       {
//         step: "05",
//         title: "Launch & Live Ops",
//         desc: "Store submission, launch monitoring, and content update pipeline setup.",
//       },
//     ],
//     stack: [
...
//       {
//         category: "Backend",
//         items: ["Firebase", "PlayFab", "Photon (Multiplayer)"],
//       },
//       { category: "Platforms", items: ["iOS", "Android", "PC/Mac", "WebGL"] },
//     ],
//     faqs: [
//       {
//         q: "How long does a mobile game take to build?",
//         a: "A casual mobile game typically takes 3–5 months from concept to App Store. Complexity drives timeline.",
//       },
//       {
//         q: "Can you add multiplayer?",
//         a: "Yes — real-time multiplayer via Photon or Firebase. We assess server costs upfront.",
//       },
//       {
//         q: "Do you handle App Store submissions?",
//         a: "Yes — store assets, age ratings, privacy policy, and review response handling included.",
//       },
//       {
//         q: "Can you update an existing Unity game?",
//         a: "Yes. We audit the codebase and provide an honest assessment before quoting.",
//       },
//     ],
//   },
...
//     description:
//       "Expert digital analytics implementation, auditing, and training — covering Google Analytics 4, Adobe Analytics, Tag Management, and advanced conversion tracking. We help businesses measure what matters, build accurate data foundations, and train their teams to use analytics confidently.",
...
//     stickyText: "we also\ntrain your team 🎓",
//     stickyBg: "bg-dc-sticky-yellow",
//     heroLabel: "// 06 — digital analytics",
//     overview:
//       "Broken tracking. Inflated metrics. Teams that can't read their own dashboards. We fix all of that. We implement GA4, Adobe Analytics, and custom Tag Manager setups from scratch — or audit and repair your existing setup. And unlike most analytics agencies, we don't just hand you a dashboard and leave. We train your team to understand, interrogate, and act on the data themselves.",
//     highlights: [
//       {
//         icon: "📊",
//         title: "GA4 Implementation & Audit",
//         body: "Full Google Analytics 4 setup, event tracking, conversion goals, ecommerce tracking, and data layer configuration.",
//       },
//       {
//         icon: "🔷",
...
//       {
//         icon: "🏷️",
//         title: "Tag Management (GTM & Launch)",
...
//         body: "Looker Studio, Power BI, and Tableau dashboards connected to your analytics data — built for your stakeholders.",
//       },
//       {
//         icon: "🎓",
//         title: "Analytics Training — GA4 & Adobe Analytics",
//         body: "We offer structured online training programmes covering Google Analytics 4 and Adobe Analytics — from fundamentals to advanced custom reporting. Live sessions with recorded access included. Available for marketing, product, and data teams of 2 to 50+.",
//         featured: true,
//       },
//     ],
//     approach: [
...
//         desc: "We audit your existing tracking setup — identify missing events, duplicate triggers, data discrepancies, and configuration errors.",
//       },
//       {
//         step: "02",
//         title: "Measurement Planning",
//         desc: "We define what to track and why — mapping your business KPIs to specific events, dimensions, and metrics.",
//       },
//       {
//         step: "03",
...
//         desc: "Custom Looker Studio or Tableau dashboards — built for your team's actual reporting needs.",
//       },
//       {
//         step: "05",
//         title: "Training & Enablement",
//         desc: "We train your team to independently use, interpret, and act on your analytics — from beginner to advanced.",
//       },
//     ],
//     stack: [
//       {
...
//         items: ["Google Tag Manager", "Adobe Launch", "Tealium"],
//       },
//       {
//         category: "Reporting",
//         items: ["Looker Studio", "Power BI", "Tableau", "BigQuery"],
//       },
//       {
//         category: "Supporting Tools",
//         items: ["Hotjar", "Microsoft Clarity", "Google Optimize", "Cookiebot"],
//       },
//     ],
//     faqs: [
//       {
//         q: "Do you provide GA4 training for beginners?",
//         a: "Yes. We offer structured GA4 training programmes for all skill levels — from marketing executives who've never used analytics to developers implementing tracking. Online and on-site options available.",
//       },
//       {
//         q: "We already have GA4. Can you audit it?",
//         a: "Absolutely. Most GA4 setups we audit have significant tracking gaps, misconfigured conversions, or missing events. An audit typically takes 3–5 days and includes a detailed report.",
//       },
//       {
//         q: "What's the difference between GA4 and Adobe Analytics?",
//         a: "GA4 is event-based, free, and integrates deeply with Google Ads. Adobe Analytics is more customisable, enterprise-grade, and better for complex data models. We implement both and advise on which fits your stack.",
//       },
//       {
//         q: "Can you train our entire marketing team?",
//         a: "Yes. We run online group training workshops — live sessions with recorded access included. Customised to your team's current skill level and your specific analytics setup. Teams of 2 to 50+.",
//       },
//     ],
//   },
...
//     description:
//       "Strategic digital marketing services that drive real business growth. From SEO and content marketing to paid campaigns and social media — we build data-driven marketing strategies that attract the right audience, convert leads, and maximise your ROI.",
//     imgSrc: "/figma/digital.jpg",
//     tags: ["SEO", "Google Ads", "Meta Ads", "Content Marketing", "Analytics"],
//     accent: "#8b5cf6",
//     stickyText: "real ROI.\nnot vanity metrics 📈",
//     stickyBg: "bg-dc-sticky-pink",
//     heroLabel: "// 07 — digital marketing",
//     overview:
//       "We market like engineers — data first, always. Every campaign we run is tracked, measured, and optimised. No vanity metrics, no inflated impressions. Just clear attribution, honest reporting, and strategies built around what actually moves the needle for your business. From organic search to paid acquisition, we cover the full funnel.",
//     highlights: [
//       {
//         icon: "🔍",
//         title: "Search Engine Optimisation",
//         body: "Technical SEO, on-page optimisation, link building, and content strategy to rank for keywords that convert.",
//       },
//       {
//         icon: "💰",
//         title: "Paid Advertising (PPC)",
//         body: "Google Ads, Meta Ads, and LinkedIn campaigns — managed for maximum ROAS, not just clicks.",
//       },
//       {
//         icon: "✍️",
//         title: "Content Marketing",
//         body: "SEO-optimised blogs, landing pages, and thought leadership content that builds authority.",
//       },
//       {
//         icon: "📱",
//         title: "Social Media Marketing",
//         body: "Organic and paid social strategies across Instagram, LinkedIn, X, and YouTube.",
//       },
//       {
//         icon: "📧",
//         title: "Email Marketing",
//         body: "Segmented campaigns, drip sequences, and newsletters that nurture leads into customers.",
//       },
//       {
//         icon: "📊",
//         title: "Analytics & Reporting",
//         body: "GA4, Search Console, and custom dashboards — full visibility into what's working and why.",
//       },
//     ],
//     approach: [
//       {
...
//         desc: "We audit your current digital presence, analyse competitors, and identify the highest-impact growth opportunities.",
//       },
//       {
//         step: "02",
...
//         desc: "Weekly performance reviews, A/B testing, bid adjustments, and creative refresh cycles.",
//       },
//       {
//         step: "05",
//         title: "Report & Advise",
//         desc: "Monthly reports with clear attribution, insights, and recommended next steps — no jargon.",
//       },
//     ],
//     stack: [
//       {
...
//       {
//         category: "Paid Ads",
//         items: ["Google Ads", "Meta Ads Manager", "LinkedIn Ads", "DV360"],
//       },
//       {
//         category: "Analytics",
//         items: ["Google Analytics 4", "Hotjar", "Mixpanel", "Looker Studio"],
//       },
//       {
//         category: "Content & CRM",
//         items: ["HubSpot", "Mailchimp", "WordPress", "Notion"],
//       },
//     ],
//     faqs: [
//       {
//         q: "How long before we see results from SEO?",
//         a: "SEO is a 3–6 month game. Paid ads can drive traffic from day one. We're upfront about realistic timelines for each channel.",
//       },
//       {
//         q: "What's your minimum ad spend?",
//         a: "We recommend a minimum monthly ad budget of ₹30,000–₹50,000 to gather meaningful data. We'll advise based on your goals.",
//       },
//       {
//         q: "Do you create the ad creatives too?",
//         a: "Yes — copywriting, static creatives, and basic video ads are included. Complex video production is scoped separately.",
//       },
//       {
//         q: "How do you measure success?",
//         a: "We agree on KPIs upfront — leads, revenue, ROAS, or CAC — and report against those. Not impressions or follower counts.",
//       },
//     ],
//   },
// ];
