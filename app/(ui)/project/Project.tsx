...
function ProjectCard({ project }: { project: Project }) {
    ...
    return (
        <section className="flex flex-col items-center space-y-6 mt-10 p-4">
            ...
            <div
                ref={ref}
                className="w-full h-[40vh] sm:h-[50vh] md:h-[60vh] lg:h-[70vh] xl:h-[80vh] bg-white rounded-xl border border-gray-300 shadow-lg relative overflow-hidden cursor-pointer"
