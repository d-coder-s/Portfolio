...
const RECEIPT_ITEMS = [
  ...
  { label: "AI / ML", checked: true },
  { label: "UI/UX", checked: true },
] as const;
      ...
      <div>
        ...
        >
          <div className="inline-flex items-center gap-2.5 border-[1.5px] border-dc-ink px-3.5 py-1.5 font-mono text-[13px] tracking-[0.18em] uppercase text-dc-ink2 mb-7">
            EST. 2024 &nbsp;·&nbsp; remote-first digital studio
        ...
        >
          // custom web development, mobile app development &amp; ui/ux design
          <br />
          //  digital analytics (google analytics, adobe analytics) · ai/ml solutions · digital marketing
          <br />
          // affordable · fast · remote-first · india-based
          <br />
        ...
        >
          ...
          >
            view our portfolio <span className="text-dc-red">→</span>
          </Link>
        </motion.div>
      </div>
        ...
        <div className="flex gap-4 items-end">
          ...
          >
            ...
            <p className="font-hand text-[16px] text-dc-ink2 leading-[1.5]">
              <span className="font-bold">✦ Now accepting</span>
              <br />
              new projects —
              <br />
              let&apos;s talk!
        ...
        <div className="flex gap-4 items-start ml-6">
          ...
          >
            ...
            <p className="font-mono text-[9px] text-white/70 leading-[1.9]">
              ...
              <br />
              &nbsp;&nbsp;type:{" "}
              <span className="text-yellow-300">&apos;remote-first&apos;</span>,
              <br />
